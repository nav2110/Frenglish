...
private MediaPlayer mediaPlayer;
    ...
    protected void onCreate(Bundle savedInstances){
        ...
        wordImage.add(new WordImage( "rouge", "red", R.drawable.red,R.raw.red));
        wordImage.add(new WordImage( "bleu", "blue", R.drawable.blue,R.raw.blue));
        wordImage.add(new WordImage( "vert", "green", R.drawable.green,R.raw.green));
        wordImage.add(new WordImage( "jaune", "yellow", R.drawable.yellow, R.raw.yellow));
        wordImage.add(new WordImage( "blanc", "white", R.drawable.white,R.raw.white));
        wordImage.add(new WordImage( "marron", "brown", R.drawable.brown,R.raw.brown));
        wordImage.add(new WordImage( "noir", "black", R.drawable.black, R.raw.black));
        wordImage.add(new WordImage( "violet", "purple", R.drawable.purple,R.raw.purple));
        wordImage.add(new WordImage( "gris", "gray", R.drawable.gray,R.raw.gray));
        wordImage.add(new WordImage( "orange", "orange",R.drawable.orange,R.raw.orange));


        WordImageArrayAdapter adapter=
                    new WordImageArrayAdapter(this,  wordImage, R.color.category_colors);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long l) {
                ...
                //get the position of the exact word the user clicked on
